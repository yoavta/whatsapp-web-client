...
//                 <Dropdown.Item href="#/action-2"><img onClick={imgClick} src={require('../assets/videoIcon.png')} width={"20px"}
//                                                       height={"20px"}/></Dropdown.Item>
//                 <Dropdown.Item href="#/action-3"><img onClick={imgClick} src={require('../assets/micIcon.png')} width={"20px"}
//                                                       height={"20px"}/></Dropdown.Item>
//             </Dropdown.Menu>
//         </Dropdown>
